...
7.1 Перейти на HTTPS (TLS 1.2+)                                           🔴 Critical 

7.2 Внедрить CSRF-токены во все формы                                     🔴 Critical 

7.3 Внедрить ограничение попыток входа (5 попыток → блокировка)           🔴 Critical 

7.4 Внедрить ролевую модель доступа                                       🔴 Critical 

7.5 Удалить `/opt/sk/password.txt`, перейти на хеширование паролей        🔴 Critical 

7.6 Ограничить типы загружаемых файлов                                    🟡 High 

7.7 Скрыть служебную информацию из клиентского кода                       🟡 High 
...
8. По защите коммерческой тайны
...
9.    Доступ к операционной системе (Ubuntu)
...
13. Если пароль admin потерян 🛠️
